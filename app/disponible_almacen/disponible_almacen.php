		...
		<section class="content">
          ...
          'boton_consultar'
             ...
             'marca_prod'
									...
									<th class="text-center" title="<?= Strings::DescriptionFromJson(
             'bulto_20'
         ) ?>"><?= Strings::titleFromJson('bulto_20') ?></th>
									<th class="text-center" title="<?= Strings::DescriptionFromJson(
             'paquete_20'
         ) ?>"><?= Strings::titleFromJson('paquete_20') ?></th>
									<th class="text-center" title="<?= Strings::DescriptionFromJson(
             'bulto_30'
         ) ?>"><?= Strings::titleFromJson('bulto_30') ?></th>
									<th class="text-center" title="<?= Strings::DescriptionFromJson(
             'paquete_30'
         ) ?>"><?= Strings::titleFromJson('paquete_30') ?></th>
									<th class="text-center" title="<?= Strings::DescriptionFromJson(
             'bulto_60'
         ) ?>"><?= Strings::titleFromJson('bulto_60') ?></th>
									<th class="text-center" title="<?= Strings::DescriptionFromJson(
             'paquete_60'
         ) ?>"><?= Strings::titleFromJson('paquete_60') ?></th>
									<th class="text-center" title="<?= Strings::DescriptionFromJson(
             'bulto_70'
         ) ?>"><?= Strings::titleFromJson('bulto_70') ?></th>
									<th class="text-center" title="<?= Strings::DescriptionFromJson(
             'paquete_70'
         ) ?>"><?= Strings::titleFromJson('paquete_70') ?></th>
								</tr>
							</thead>
							<tfoot style="background-color: #ccc;color: white;">
								<tr>
									...
									<th class="text-center"><?= Strings::titleFromJson('bulto_20') ?></th>
									<th class="text-center"><?= Strings::titleFromJson('paquete_20') ?></th>
									<th class="text-center"><?= Strings::titleFromJson('bulto_30') ?></th>
									<th class="text-center"><?= Strings::titleFromJson('paquete_30') ?></th>
									<th class="text-center"><?= Strings::titleFromJson('bulto_60') ?></th>
									<th class="text-center"><?= Strings::titleFromJson('paquete_60') ?></th>
									<th class="text-center"><?= Strings::titleFromJson('bulto_70') ?></th>
									<th class="text-center"><?= Strings::titleFromJson('paquete_70') ?></th>
								</tr>
							</tfoot>
							<tbody>
